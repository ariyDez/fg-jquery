(function ($) {
    ...
    const methods = {
        ...
        generateInputElement: function (inputElement) {
            ...
            function selectInput(input) {
                function optionRender() {
                    ...
                    let optionsHtml = `<option>--Choose--</option>`;
        ...
        giveSelection: function (e) {
            ...
            $current = $(this);
            let id = $current.attr('id').replace(/^\D+/g, '');
            let number = ++id;
            const $sel2 = $(`#select-name${number}`);
            console.log(number);
        ...
        fillChildSelect: function(e) {
            $current = $(this);
            const childId = $current.attr('child');
            const parentOptionId = $current.val();
            const child = globalInputs.find((function(input) {
